 ...
 */
final class Version20190912162236 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE payment (id INT AUTO_INCREMENT NOT NULL, payment INT DEFAULT NULL, number VARCHAR(255) DEFAULT NULL, securitynumber VARCHAR(255) DEFAULT NULL, hidden INT DEFAULT NULL, deleted INT DEFAULT NULL, crdate INT DEFAULT NULL, tstamp INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
